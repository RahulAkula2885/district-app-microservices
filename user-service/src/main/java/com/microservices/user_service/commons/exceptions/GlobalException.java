...
public class GlobalException implements ErrorController {
    ...
    public ResponseEntity<CommonResponse> usernameNotFoundException(UsernameNotFoundException ex) {
    ...
    public ResponseEntity<CommonResponse> authenticationException(AuthenticationException ex) {
    ...
    public ResponseEntity<CommonResponse> jwtException(JwtException ex) {
    ...
    public ResponseEntity<CommonResponse> handleJWTVerificationException(JWTVerificationException ex) {
    ...
    public ResponseEntity<CommonResponse> signatureVerificationException(SignatureVerificationException ex) {
    ...
    public ResponseEntity<CommonResponse> tokenExpiredException(TokenExpiredException ex) {
