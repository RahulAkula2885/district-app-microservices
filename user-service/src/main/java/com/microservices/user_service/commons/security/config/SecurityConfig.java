package com.microservices.user_service.commons.security.config;

import com.microservices.user_service.commons.security.jwt.JwtAuthorizationFilter;
...
public class SecurityConfig {
    ...
    protected static final String[] PUBLIC_URLS = {"/v1/app/users/create/**", "/v1/app/users/login/**", "/v1/admin/users/create/**", "/v1/admin/users/login/**", "/user-service/**"};
